...
In order to enter the database, select the language of your choice by either clicking on the respective symbol or selecting it from the top menu bar, under “Database.” 
            ...
            <p>
In order to submit an inquiry select a text from the dropdown list by using their respective catalogue numbers (for details, see the guidelines to the individual languages). Once the matches have been generated (Text View), you can view them by either scrolling down and up or by selecting the passage you are interested in by selecting the respective folio number from the dropdown list. 
            </p>
<h3>Global Text Search</h3>
<p>
The Global Text Search offers a search by a text passage. Upon typing in a text passage (max. length 150  characters), a list with the pertinent hits will be displayed. A click on any of the results  will display the full text in the Text View modus.</p>
            ...
            <p>
              <ul>
                <li><b>Text</b> View: Upon selecting a file, the entire Inquiry Text with the passages for which matches are found is shown. The presence of matches in the Inquiry Text is indicated bv colours. Upon selecting (by clicking) any of these positions , the matches found in various Hit Texts for that position will be displayed in a new column. By clicking on any of these matches the respective Hit Text will be displayed  in yet another column, with the match in question highlighted. All matches with the Inquiry Text found in the displayed Hit Text are coloured.  </li>
                <li><b>Table</b> View: Displays a table of the matches found for the current  Inquiry Text.</li>
                <li><b>Graph</b> View: Displays various graphs visualizing the (approximate) matches found for the Inquiry Text. The pie graph displays the distribution of the (approximate) matches according to the collection’s sections. The histogram shows the distribution of the top files that have matches with the Inquiry Text based on the accumulated length of the approximate matches. A maximum of 50 hit texts are shown.</li>
              </ul>
            </p>
            <h3>Visual Charts</h3>
            <p>The Visual Charts display the intertextuality between collections, sections within collections, and single texts using a Sankey diagram. To choose a language, click on the respective symbol. Upon selecting the Inquiry and Hit collections, a Sankey diagram displaying the distribution of the matches will be generated. The display colouring scheme is available in three options: gradient, according to the Inquiry Collection, or according to the Hit Collection. You can reduce the display to a single section (by clicking), and then further to a single text. A click on the selected text leads you to Text View, where the matches of the selected text (Inquiry Text) are displayed. 
            </p>
          </div>
        </div>
      </div>
