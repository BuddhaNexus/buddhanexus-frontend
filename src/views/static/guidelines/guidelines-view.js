          ...
          <div class="main-content">
            ...
            <p>
              <ul>
                ...
                <li><b>Numbers View:</b>: Displays a table with the segment numbers of the matches found for the current Inquiry Text. This view mode is only available for Pāli and Chinese texts, where the segment numbers represent the PTS and Taisho numbers, respectively.</i>
