            ...
            <ol>
              <li>
                ...
                <a
                  ...
                  >SuttaCentral</a
                >
                and individual scholars. The Sanskrit collection has been
                accordingly reorganized. For practical and structural reasons,
                the corpus of Buddhist texts is thematically arranged in
                accordance with the organization of the Tibetan Buddhist Canon.
                An overview of the new organization can be found in the sidebar
                upon clicking the triple bar symbol
                <iron-icon
                  class="info-icon"
              ...
              <li>
                ...
                multilingual data has been automatically generated. Accordingly,
                the multilingual alignments are currently only offered to those
                texts for which relatively good results could be achieved.
              </li>
              <li>
                On the Pāli side, a new “English mode” was introduced. This view
                mode displays the Pāli text together with an English translation
                generated by by the
                <a
                  target="_blank"
                  class="content-link"
                ...
                >. This machine-made translation merely aims at facilitating
                research and should thus be by no means considered definite.
                Whenever available, an English translation by Bhikkhu Sujato
                (Suttas) or Bhikkhu Bhahmali (Vinaya) is also offered.
              </li>
              <li>
